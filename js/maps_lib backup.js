...
var MapsLib = {
  ...
  getList: function(whereClause) {
    ...
    var tempColumn  = [];
    if ( $("#Show0").is(':checked')) tempColumn.push("'Nombre muestra'");
    if ( $("#Show1").is(':checked')) tempColumn.push("'Potencial Redox (mV)'");
	if ( $("#Show2").is(':checked')) tempColumn.push("'pH'");
	if ( $("#Show3").is(':checked')) tempColumn.push("'Conductividad (µS/cm)'");	
	
    //var selectColumns = "'Nombre muestra', 'Potencial Redox (mV)', 'pH',  'Conductividad (µS/cm)', Mo, Zr, Sr, U, Rb";
	selectColumns = tempColumn.join()
